...
# Day 1 — Player controller, combat, time hop
...
- [x] Inventory have 2 part: 1. the big inventory window open by "O" and 2. a overlay bar at the bottom for quick access (4hr)
  - The idea is:
...
# Day 3 — Inventory, crafting, cleanup
